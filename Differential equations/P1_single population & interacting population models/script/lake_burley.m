...
%constant rates of flow and pollution
                  ...
                  % c0 > cin
cin = 3*10^6 ; V = 28*10^6; F = 4*10^6; c0 = 3.5*10^6; tend = 100;
t = linspace(0,1,N);
[tsol, ysol] = ode45( @derhs, [0, tend], c0 );

cin = 3*10^6 ; V = 28*10^6; F = 4*10^6; c0 = 3.6*10^6; tend = 100;
t = linspace(0,1,N);
[tsol1, ysol1] = ode45( @derhs, [0, tend], c0 );

cin = 3*10^6; V = 28*10^6; F = 4*10^6; c0 = 3.7*10^6; tend = 100;
t = linspace(0,1,N);
[tsol2, ysol2] = ode45( @derhs, [0, tend], c0 );

cin = 3*10^6; V = 28*10^6; F = 4*10^6; c0 = 3.8*10^6; tend = 100;
t = linspace(0,1,N);
[tsol3, ysol3] = ode45( @derhs, [0, tend], c0 );

cin = 3*10^6; V = 28*10^6; F = 4*10^6; c0 = 3.9*10^6; tend = 100;
t = linspace(0,1,N);
[tsol4, ysol4] = ode45( @derhs, [0, tend], c0 );


    % cin > c0
cin = 3*10^6 ; V = 28*10^6; F = 4*10^6; c0 = 2.5*10^6; tend = 100;
t = linspace(0,1,N);
[tsol5, ysol5] = ode45( @derhs, [0, tend], c0 );

cin = 3*10^6 ; V = 28*10^6; F = 4*10^6; c0 = 2.6*10^6; tend = 100;
t = linspace(0,1,N);
[tsol6, ysol6] = ode45( @derhs, [0, tend], c0 );

cin = 3*10^6; V = 28*10^6; F = 4*10^6; c0 = 2.7*10^6; tend = 100;
t = linspace(0,1,N);
[tsol7, ysol7] = ode45( @derhs, [0, tend], c0 );

cin = 3*10^6; V = 28*10^6; F = 4*10^6; c0 = 2.8*10^6; tend = 100;
t = linspace(0,1,N);
[tsol8, ysol8] = ode45( @derhs, [0, tend], c0 );

cin = 3*10^6; V = 28*10^6; F = 4*10^6; c0 = 2.9*10^6; tend = 100;
t = linspace(0,1,N);
...
title(' Costant flow and Concetration')
