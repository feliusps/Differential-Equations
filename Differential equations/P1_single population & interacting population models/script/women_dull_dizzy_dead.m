...
%Drink on an emty stomach for women 
function dull_dizzy_dead
global k1 k2 k3 Climit ;
k1=6; k2=6; k3=0.019; Climit=0.05;

tend= 6; %end time in hours

% 3 drink c10=0.102, 2 drinks C10 =0.068 , 1drink C10=0.034
...
title(' Woman drinking with enty stomach')
...
M=double(0.005);
C1 = u(1); C2=u(2);
C1dot =-k1*C1; %drinkink continuously add I=(n/t)*cs
